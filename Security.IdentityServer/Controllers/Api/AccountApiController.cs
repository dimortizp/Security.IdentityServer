...
using Security.IdentityServer.Models.AccountViewModels;
...
namespace Security.IdentityServer.Controllers.Api
{
    ...
    public class AccountApiController : Controller
    {
        ...
        public async Task<IActionResult> GenerateToken([FromBody] LoginViewModel model)
        {
            ...
            //var jsonResult = new JsonResult(new { error = "Credenciales incorrectas." });
            //jsonResult.StatusCode = Microsoft.AspNetCore.Http.StatusCodes.Status409Conflict;
            //return jsonResult;
        }
    }
}